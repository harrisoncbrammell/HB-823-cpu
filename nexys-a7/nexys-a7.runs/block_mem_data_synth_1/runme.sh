...
HD_PWD='D:/Development/School/computer_arch/cpu_project/nexys-a7/nexys-a7.runs/block_mem_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_mem_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_mem_data.tcl
