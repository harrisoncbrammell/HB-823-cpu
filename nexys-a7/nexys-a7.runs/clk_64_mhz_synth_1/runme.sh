...
HD_PWD='D:/Development/School/computer_arch/cpu_project/nexys-a7/nexys-a7.runs/clk_64_mhz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_64_mhz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_64_mhz.tcl
