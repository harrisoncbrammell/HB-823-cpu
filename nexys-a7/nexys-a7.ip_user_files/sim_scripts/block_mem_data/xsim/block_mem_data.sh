...
#
# Script generated by Vivado on Wed Apr 15 18:58:55 -0500 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : block_mem_data.sh
...
#
# Usage        : block_mem_data.sh
#                block_mem_data.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                block_mem_data.sh [-rerun]
#                block_mem_data.sh [-reset_run]
#                block_mem_data.sh [-clean]
#                block_mem_data.sh [-reset_log]
#                block_mem_data.sh [-help]
#
...
# script info
echo -e "block_mem_data.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./block_mem_data.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot block_mem_data xil_defaultlib.block_mem_data xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim block_mem_data -key {Behavioral:sim_1:Functional:block_mem_data} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb block_mem_data.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./block_mem_data.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: block_mem_data.sh [-help]\n\
Usage: block_mem_data.sh [-step]\n\
Usage: block_mem_data.sh [-lib_map_path]\n\
Usage: block_mem_data.sh [-rerun]\n\
Usage: block_mem_data.sh [-reset_run]\n\
Usage: block_mem_data.sh [-clean]\n\
Usage: block_mem_data.sh [-reset_log]\n\
Usage: block_mem_data.sh [-keep_index]\n\
Usage: block_mem_data.sh [-noclean_files]\n\n\
