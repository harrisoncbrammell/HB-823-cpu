...
#                script (type 'block_mem_data.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Development/School/computer_arch/cpu_project/nexys-a7/nexys-a7.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
